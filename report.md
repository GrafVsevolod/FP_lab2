...
Команда:
mix test
Результаты выполнения команд приведены на скриншотах ниже.

### Структура проекта
На рисунке показана структура файлов проекта после сборки.

![Структура проекта](images/01_ls.png)

### Сборка проекта
Проект успешно компилируется без ошибок.

![Сборка проекта](images/02_compile.png)

### Результаты unit и property-based тестирования
Все unit-тесты и property-based тесты пройдены успешно, ошибок не обнаружено.

![Результаты тестов](images/03_mix_test.png)

### Демонстрация работы API (iex)
Ниже показана интерактивная работа со структурами `Dict`, `Set` и `Bag`
в интерактивной консоли Elixir (`iex -S mix`).

![Демонстрация API](images/04_iex_demo.png)
